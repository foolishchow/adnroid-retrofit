...
public class RetrofitHack {
    ...
    public static RequestAction getRequestAction(
        ...
        if (Iterable.class.isAssignableFrom(rawParameterType)) {
            ...
            action = new RetrofitHack.QueryBean<>(parameterType, converter).iterable();
          ...
          Class<?> arrayComponentType = boxIfPrimitive(componentType);
            ...
            action = new RetrofitHack.QueryBean<>(parameterType, converter).array();
        } else {
            Converter<?, String> converter =
                    retrofit.stringConverter(parameterType, parameterAnnotations);
            action = new RetrofitHack.QueryBean<>(parameterType, converter);
        }
        return action;
    }
